...
prefilt_dict = {'type': 'AdapTrans', 'dt': 5.0, 'min_freq': 500, 'max_freq': 20000, 'scale': 'mel'}
...
def model_init_fn():
    ...
    model = ConvNet2D(n_frequency_bands=F, kernel_size=(6, 15), c_hidden=10, n_hidden=90, out_neurons=1, prefiltering=prefilt_dict)
...
for neuron_idx in neuron_indices:
    ...
    def data_split_func(dataset_and_split_info):
        train_set, valid_set, test_set = torch.utils.data.random_split(dataset, WEHR_NEURONS_SPLIT_NATURAL[WEHR_VALID_NEURONS[neuron_idx]])
